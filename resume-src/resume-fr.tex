...
\resumeSubheading
  ...
  \resumeItemListStart
    \item Développement en autonomie d'une application de bureau Java/JavaFX pour la gestion du
      personnel ouvrier de la commune : gestion des profils, suivi des absences et calcul
      automatisé des salaires.
    \item Conception de la base de données relationnelle (MySQL/MariaDB) : dictionnaire de
      données, dépendances fonctionnelles et modèle conceptuel, à partir du recueil des
      besoins auprès du service concerné.
...
\section{Projets}
  \resumeSubHeadingListStart
    ...
    \resumeSubItem{BacSurveillance}
      {Plateforme de gestion de surveillance d'examens avec algorithme greedy + backtracking pour l'affectation automatique des enseignants. Backend FastAPI/PostgreSQL, frontend React 19 (TypeScript), export Word/Excel et interface bilingue Arabe/Français.
      \href{https://github.com/HexNebula/BacSurveillance}{\underline{GitHub}}}
      \vspace{2pt}
    \resumeSubItem{FitHub}
      {Application full stack de gestion de salle de sport en architecture microservices avec pipelines CI/CD via GitHub Actions.
